...
export const Rules = () => {
    ...
    {/* Back button */}
        <div className="rules-screen__top-bar">
            <button className="rules-screen__back-btn" onClick="history.back()" aria-label="Back to start screen">
                <Link to="/gamePage"><img src={poop} alt="Back icon" className="rules-screen__back-icon" /></Link>
            </button>
            <button className="rules-screen__language-btn" aria-label="Change language">
                <img src={translate} alt="Language icon" className="rules-screen__language-icon" />
            </button>
        </div>
    ...
    {/* <!-- fun fact --> */}
    <p className="rules-screen__quote">"Being a good dog owner starts with the little things!" 🐾</p>
  </main>
)
};
